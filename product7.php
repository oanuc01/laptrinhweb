                        ...
                        <div class="row">
                                ...
                                <div class="my_tabs">
                                    <div class="tab-content tab_content_style">
                                        ...
                                        <div id="tab2" class="tab-pane fade">
                                            <div class="blog_tabs">
                                                <a class="fancybox" href="images/ex2.png" data-fancybox-group="gallery" title="">
                                        ...
                                        <div id="tab3" class="tab-pane fade">
                                            <div class="blog_tabs">
                                                <a class="fancybox" href="./images/ex1.png" data-fancybox-group="gallery" title="">
                                        ...
                                        <ul class="tab_style tab_bottom">
                                            <li class="active">
                                                <div class="blog_single_carousel">
                                                    <a data-toggle="tab" href="#tab1"><img src="./images/ex3.png" alt="" /></a>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="blog_single_carousel">
                                                    <a data-toggle="tab" href="#tab2"><img src="images/ex2.png" alt="" /></a>
                                                </div>
                                            </li>

                                            <li>
                                                <div class="blog_single_carousel">
                                                    <a data-toggle="tab" href="#tab3"><img src="images/ex1.png" alt="" /></a>
                                                </div>
                                            </li>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="blog_product_details">
                                    <h2 class="blog_heading"><a href="">Iliving ILG8VF10 Ventilator Fan</a></h2>
                                    ...
                                    <div class="pricing_rate">
                                        ...
                                        <p class="blog_texts">
                                            ...
                                            <ul class="aboutthisitem">
                                                <li>Super powerful exhaust or intake Ventilator Fan, 350W, 1942 CFM, 3450 RPM.</li>
                                                <li>Super Heavy Duty Rugged construction, Roller Steel Framing for long-lasting use.</li>
                                                <li>Auto Reset thermal protection, 100% copper Fully Enclosed Direct Drive Motor.</li>
                                                <li>120V, 60Hz UL listed UL507 Standard.</li>
                                                <li>Available sizes at 10”, 12”, 16”, 20”, and 24”</li>
                                            </ul>
                                        </p>
                                    </div>
                                ...
                                <div class="product_options_area">
                                    <img src="./images/ex5.png" height="497px" width="100%" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <table class="table table-bordered  table-striped">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>1 year part & component limited warranty</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>High velocity fan, user's manual</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
