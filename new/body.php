  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <a class="right carousel-control _26sdfg" href="#myCarousel" data-slide="next">
      ...
      <span class="sr-only">Tra Tiếp</span>
    </a>
  </div>
</div>
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							...
							<div class="shop-body">
								<h3>Laptop<br>Thêm Vào Giỏ Hàng</h3>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							...
							<div class="shop-body">
								<h3>Accessories<br>Thêm Vào Giỏ Hàng</h3>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							...
							<div class="shop-body">
								<h3>Cameras<br>Thêm Vào Giỏ Hàng</h3>
                        ...
                        eThêm "
								...
								<div class='product'>
									...
									<div class='product-body'>
										<p class='product-Danh Mục'>$cat_name</p>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<p>Khuyến Mãi Sản Phẩmm mới lên đến 50%</p>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							<h3 class="title">Những Sản Phẩm được ưa chuộng</h3>
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 col-xs-6">
						<div class="section-title">
							<h4 class="title">Những Sản Phẩm được ưa chuộng</h4>
							<div class="section-nav">
