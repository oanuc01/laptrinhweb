                  ...
                  <table class="table tablesorter " id="page1">
                    <thead class=" text-primary">
                      <tr>
                        ...
                        <th>Tên sản phẩm</th>
                        <th>Giá</th>
                        <th><a class=" btn btn-primary" href="addproduct.php">Thêm mới</a></th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php 

                        $result=mysqli_query($con,"select product_id,product_image, product_title,product_price from products  where  product_cat=2 or product_cat=3 or product_cat=4 Limit $page1,12");
                        ...
                        <a class=' btn btn-success' href='clothes_list.php?product_id=$product_id&action=delete'>Xóa</a>
                        </td></tr>";
                        }
