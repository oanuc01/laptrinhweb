		...
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='Thêm-vào-giỏ-hàng'>
										<button pid='$pro_id' id='product' class='Thêm-vào-giỏ-hàng-btn block2-btn-towishlist' href='#'><i class='fa fa-shopping-cart'></i> Thêm vào giỏ hàng </button>
									</div>
								</div>
                                </div>
			...
			echo "
                        ...
                        <div class='col-md-4 col-xs-6'>
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='Thêm-vào-giỏ-hàng'>
										<button pid='$pro_id' id='product' href='#' tabindex='0' class='Thêm-vào-giỏ-hàng-btn'><i class='fa fa-shopping-cart'></i> Thêm vào giỏ hàng </button>
									</div>
								</div>
							</div>
			";
