						...
						<!-- /Billing Details -->
								...
								<form id="signup_form" onsubmit="return false" class="login100-form">
                                    ...
                                    <div class="section-title">
                                        <h2 class="login100-form-title p-b-49" >Đăng ký ở đây</h2>
                                    </div>
                                    <div class="form-group ">
                                    
                                        <input class="input form-control input-borders" type="text" name="f_name" id="f_name" placeholder="Họ đệm">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="text-pad">
                                    <a href="" data-toggle="modal" data-target="#Modal_login">Bạn đã có tài khoản? Đăng nhập thôi</a>
