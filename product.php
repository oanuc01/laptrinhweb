                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<ul class="product-links">
								<li>Loại:</li>
								<li><a href="#">Thời trang trẻ em nữ</a></li>
								<li><a href="#">Thời trang trẻ em nam</a></li>
							</ul>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Khánh</h5>
															<p class="date">11/3/2022, 8:0 PM</p>
													...
													<li>
														<div class="review-heading">
															<h5 class="name">Linh</h5>
															<p class="date">01/03/2022, 5:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
													...
													<li>
														<div class="review-heading">
															...
															<p class="date">25/03/2022, 9:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
